                        ...
                        @if (count($Ordemservico) > 0)
                            ...
                            @foreach ($Ordemservico as $Os)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/veiculo/perfil/{{ $Os->id_veiculo }}" class="text-dark">
                                            <span class="text-primary fs-5">
                                    ...
                                    <td>
                                        <a href="/funcionario/perfil/{{ $Os->id_supervisor }}" class="text-dark">
                                            <span class="text-dark fs-5">
                                                <i class="bi bi-person-workspace"></i>
                                                {{ $Os->supervisor_nome }}
                                                {{ $Os->supervisor_sobrenome }}
                                          </a>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        {{ date('d/m/Y', strtotime($Os->dataHora)) }}

                                        {{ date('H:m:s', strtotime($Os->dataHora)) }}
                                    </td>

                                    <td class="text-center" title="Editar">
                                        <a class="btn btn-danger" href="/os/imagens/{{ $Os->id_os }}"><i
                                                class="bi bi-card-image"></i>
                                    <td class="text-center" title="Editar">
                                        <a class="btn btn-primary" href="/os/editar/{{ $Os->id_os }}">
                                            <i class="bi bi-pen-fill"></i>
                                    </td></a>

                                    </td></a>
                                    <td title=""><a class="btn btn-warning fs-5"
                                            href="/os/checklist/{{ $Os->id_os }}">
                                            <i class="bi bi-ui-checks-grid"></i></td></a>

                                    <td class="text-center" title="imprimir"><a class="btn btn-info fs-5"
                                            href="/os/imprimir/{{ $Os->id_os }}" target="blanck"><i
