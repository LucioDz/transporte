...
@section('content')
    ...
    <div class="container p-5">
        ...
        <div class="pagetitle">
            ...
            <h1>
                <i class="bi bi-truck"></i>
                Cadastro de Veiculos</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/Bases/listar">Veiculos</a></li>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                                    ...
                                    <!-- Profile Edit Form -->
                                    <form action="/veiculo/cadastrar" method="post" enctype="multipart/form-data"
                                    class="formulario">
                                        @csrf
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="marca" type="text" id="marca" value="{{ old('marca') }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="ano_fabrico" type="number" min="1980" id="ano_fabrico"
                                                    ...
                                                    class="form-control @error('ano_fabrico') is-invalid @enderror" min="1999"
                                                    max="{{ date('Y') }}">
                                                @error('ano_fabrico')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                ...
                                <div class="col-md-8 col-lg-9">
                                    <div class="form-check  pb-2">
                                        <input class="form-check-input" type="checkbox" id="changesMade"
                                            name="situacao[]" value="Em uso"
                                            @if(is_array(old('situacao')) && in_array('Em uso',old('situacao')) )checked @endif>
                                    ...
                                    <div class="form-check pb-2">
                                        <input class="form-check-input" type="checkbox" id="newProducts"
                                            ...
                                            @if(is_array(old('situacao')) && in_array('Em Garagem',old('situacao')) )checked @endif>
                                    ...
                                    <div class="form-check pb-2">
                                        <input class="form-check-input" type="checkbox" id="proOffers"
                                            ...
                                            @if(is_array(old('situacao')) && in_array('Em Manutenção',old('situacao')) )checked @endif>
