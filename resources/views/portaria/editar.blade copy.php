                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                                    ...
                                    <!-- Profile Edit Form -->
                                    <form action="/funcionario/actulizar/{{$funcionario->id_funcionario}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                      @method('PUT')
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                @if ($funcionario->imagem != null)
                                                    <img src="{{asset('storage/'.$funcionario->imagem) }}"
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <select aria-label="Default select example" name="base"
                                                    ...
                                                    <option value="cazenga"
                                                        @if (old('base') == 'cazenga') selected @endif>cazenga</option>
                                                    <option value="viana" @if (old('base') == 'viana') selected @endif>
                                                        viana</option>
                                                </select>
                                                @error('base')
                                                    <div class="invalid-feedback">
                ...
                <div class="col-xl-5 ">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="form-check pb-2">
                                        <input class="form-check-input" type="checkbox" id="proOffers"
                                            name="funcionario_tipo[]" value="administrador" @if($funcionario->funcionario_tipo=='administrador')checked @endif>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="card  p-5">
                            ...
                            <div class="row mb-3">
                                <label for="currentPassword" class="col-md-4 col-lg-3 col-form-label">Usuario</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="funionario_email" type="text" id="funionario_email"
                                        value="{{ old('funionario_email') }}"
                                        class="form-control @error('funionario_email') is-invalid @enderror">
                                    @error('funionario_email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <label for="newPassword" class="col-md-4 col-lg-3 col-form-label">
                                    Senha</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="funionario.senha" type="password" id="funionario_senha"
                                        value="{{ old('funionario_senha') }}"
                                        class="form-control @error('funionario_senha') is-invalid @enderror">
                                    @error('funionario_senha')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <label for="newPassword" class="col-md-4 col-lg-3 col-form-label">
                                    Comfirmar senha</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="funionario_confirmar_senha" type="password" id="funionario_confirmar_senha"
                                        value="{{ old('funionario_confirmar_senha') }}"
                                        class="form-control @error('funionario_confirmar_senha') is-invalid @enderror">
                                    @error('funionario_confirmar_senha')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
