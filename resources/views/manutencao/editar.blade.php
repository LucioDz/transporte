...
@section('content')
    ...
    <div class="container my-5" style="border:0px solid #000000">
        ...
        <main id="main" class="main">
            ...
            @error('item_check')
                ActualizarManutencaoPreventiva
                <div class="alert alert-danger fs-5 text-center col-6 mx-auto">
                    {{ $message }}
                </div>
            @enderror
                    ...
                    <div class="col-md-8 col-lg-8 mx-auto">
                        <div class="card" style="border:3px solid #000000">
                            <div class="card-body">
                                ...
                                <form id="FormularioManutencaoPreventivaEditar">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="previsao_da_manutencao"
                                            ...
                                            value={{ old('situacao_os', $manutencao_preventiva[0]->previsao_da_manutencao) }}>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-1 mt-1">
                        <button class="btn btn-outline-warning btn-sm" type="button" title="Adcionar Checklist">
    ...
    <div class="modal fade" id="formulario-actualizar" tabindex="-1" aria-labelledby="formulario-actualizarLabel"
