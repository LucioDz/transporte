...
@section('content')
    ...
    <div class="container  mb-5">
        ...
        <div class="row my-5">
            ...
            <h1 class="text-center">Editar Imagem Registradas na {{ $portaria[0]->portaria_tipo }} Veiculo
                {{ $portaria[0]->prefixo }} </h1>
        ...
        <div class="row text-center mt-5">
            ...
            <div class="col-md-8 col-lg-8 mx-auto text-center">
                <form method="POST" action="actualizar/{{$imagem->id_portaria_imagem }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                    ...
                    <div class="mt-2">
                        ...
                        onclick="mostrar_cadastrar()">Actualizar</button>
                    </div>
