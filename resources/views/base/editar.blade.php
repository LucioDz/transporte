                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                                    ...
                                    <!-- Profile Edit Form -->
                                    <form action="/base/actualizar/{{ $base[0]->id_base }}" method="post"
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                ...
                                                @else
                                                    <img src="/img/perfilsemfoto.jpg" height="150px" alt="Profile"
                                                        id="photo_ferfil"
                                                        class="@error('foto_de_perfil') is-invalid @enderror">
                                                @endif
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="nome_base" type="text" id="nome_base"
                                                    value="{{ old('nome_base', $base[0]->nome_base) }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <textarea name="descricao" class="form-control" id="about" style="height: 100px">{{ old('descricao', $base[0]->descricao_base) }}</textarea>
                                            </div>
                                        </div>
