    ...
    <div class="container">
        <table style="width:100%;margin-top:0;margin-bottom:0;">
            ...
            <tr style="border:2px solid #000000;">
                <td style="width:30%">
                    <span class="bolder">Base:</span>{{ $portaria[0]->nome_base}}
                </td>
                <td style="width:35%">
                    <span class="bolder">Provincia:</span>{{ $portaria[0]->nome_provincia }}
                </td>
                <td style="width:35%">
                    <span class="bolder"> Municipio:</span>{{ $portaria[0]->nome_municipio }}
                </td>
            </tr>

            <tr style="border:2px solid #000000;">
                <td style="width:60%">
                    <span class="bolder">Checklist Rapido do veiculo / {{ $portaria[0]->portaria_tipo }}</span>
                </td>
                <td style="width:20%">
                    Data:{{ date('d/m/Y', strtotime($portaria[0]->dataHora)) }}
                </td>
                
                <td style="width:20%">
                    Hora:{{ date("H:m:s",strtotime($portaria[0]->dataHora)) }}
                </td>
        ...
        <table style="width:100%;margin-bottom:0;margin-top:0">
            <tr style="border:3px solid #000000">
                <td style="width:50%;  border-left:3px solid #000000">
                    <span style="text-align: center;">&nbsp; Motorista</span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->motorista_nome }} {{ $portaria[0]->motorista_sobrenome }}
                    </p>
                    <span style="text-align: center;">&nbsp; MAC</span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->motorista_numero_mecanografico }}
                    </p>
                </td>

                <td style="width:50%;  border-left:3px solid #000000">
                    <span style="text-align: center;">&nbsp;cobrador</span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->cobrador_nome }} {{ $portaria[0]->cobrador_sobrenome }}
                    </p>
                    <span style="text-align: center;">&nbsp; MAC</span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->cobrador_numero_mecanografico }}
                    </p>
                </td>
        ...
        <table style="width:100%;margin-top:0;margin-bottom:0">
            <tr style="border:3px solid #000000">
                <td style="width:50% border-left:3px solid #000000">
                    <span style="text-align: center;">&nbsp; Matricula</span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->matricula }}
                    </p>
                    <span style="text-align: center;">&nbsp;Prefixo</span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->prefixo }}
                    </p>
                </td>
                ...
                <td style="width:50%;  border-left:3px solid #000000">
                    <span style="text-align: center;">&nbsp;Marca </span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->marca }}
                    </p>
                    <span style="text-align: center;">&nbsp;Kilometragem</span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->portaria_kilometragem }}
                    </p>

                    <span style="text-align: center;">&nbsp;situação</span>
                    <p style="border:3px solid #0000002a;border-radius:2%;padding: 10px;">
                        {{ $portaria[0]->situcao_veiculo }}
                    </p>
                </td>
